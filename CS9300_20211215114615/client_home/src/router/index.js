...
const routes = [
	...
	//最新电影列表路由
	{
		path: '/the_latest_movie/list',
		name: '/the_latest_movie_list',
		component: () => import('../views/the_latest_movie/list.vue')
	},
	//最新电影详情路由
	{
		path: '/the_latest_movie/details',
		name: '/the_latest_movie_details',
		component: () => import('../views/the_latest_movie/details.vue')
	},
	//电影列表路由
	{
		path: '/film/list',
	...
	//电影详情路由
	{
		path: '/film/details',
		name: '/film_details',
		component: () => import('../views/film/details.vue')
	},
	//订单中心添加路由
	{
...
router.afterEach((to, from, next) => {
	let title = "电影院管理系统-home";
	document.title = title;
	document.logo = "电影院管理系统"
})
