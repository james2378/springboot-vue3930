<template>
	<div>
		...
		<b-form-group v-if="$check_register_field('add','date_of_birth','/user_registration/view')" id="input-group-1" label="出生日期" label-for="input-1">
			<b-form-input id="input-1" v-model="form['date_of_birth']" type="text" placeholder="出生日期" trim></b-form-input>
		</b-form-group>
	</div>
</template>
