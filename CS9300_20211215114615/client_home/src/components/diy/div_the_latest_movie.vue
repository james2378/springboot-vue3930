<template>
	<div class="diy_details_box diy_div_the_latest_movie">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
						...
						<!-- 图片 -->
							...
							<div class="details_btn_wrap">
								...
								<button class="btn btn-primary details_btn" v-if="$check_action('/the_latest_movie/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
