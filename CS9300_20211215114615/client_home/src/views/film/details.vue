<template>
	<div class="diy_details page_film" id="film_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_film'>
							<div_film :obj="obj"></div_film>
						</div>
					</div>
				</div>
			</div>
...
<script>
	import div_film from "@/components/diy/div_film.vue";
	...
	export default {
		...
		methods:{
			...
			add_hits(obj) {
				obj["hits"] = obj["hits"] + 1;
				var hits = obj["hits"];
				this.$post('~/api/film/set?film_id=' + obj["film_id"], {
					hits
				}, (res) => {
					if(res.result){
