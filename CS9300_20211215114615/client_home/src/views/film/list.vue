<template>
	<div class="diy_list page_film" id="film_list">
		<div class="warp">
			<div class="container diy_list_container">
				<div class="diy_list_title">
					<div class="col">
						<span class="title">电影列表</span>
					</div>
				</div>
				...
				<div class="diy_list_select_box">
					<span class="diy_list_select_title">下拉搜索：</span>
						...
						<div class="col">
							<!-- 筛选 -->
							<div class="view">
								<b-dropdown text="电影分类" variant="outline-dark" left>
									<b-dropdown-item @click="filter_set('全部','film_classification')">全部</b-dropdown-item>
										<b-dropdown-item v-for="(o, i) in list_film_classification" :key="i" @click="filter_set(o['film_classification'],'film_classification')" >
												{{ o['film_classification'] }}
										</b-dropdown-item>
								</b-dropdown>
								<b-dropdown text="场次" variant="outline-dark" left>
									<b-dropdown-item @click="filter_set('全部','number_of_sessions')">全部</b-dropdown-item>
										<b-dropdown-item v-for="(o, i) in list_number_of_sessions" :key="i" @click="filter_set(o['number_of_sessions'],'number_of_sessions')" >
...
<script>
	...
	export default {
		...
		methods: {
			 ...
			 * 筛选
			 */
			filter_film_classification(o) {
				if (o == "全部") {
					this.query["film_classification"] = "";
				} else {
					this.query["film_classification"] = o;
				}
				this.search();
			},
			filter_number_of_sessions(o) {
				if (o == "全部") {
					this.query["number_of_sessions"] = "";
				} else {
					this.query["number_of_sessions"] = o;
				}
				this.search();
			},
